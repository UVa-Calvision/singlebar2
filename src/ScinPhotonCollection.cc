...
// ----- ScinPhotonCreation
G4ThreadLocal G4Allocator<ScinPhotonCreation>* SPCHitAllocator = nullptr;

ScinPhotonCreation::ScinPhotonCreation()
  : energy(0.), time(0.)
{}

ScinPhotonCreation::ScinPhotonCreation(G4double e, G4double t)
  : energy(e), time(t)
{}

ScinPhotonCreation::~ScinPhotonCreation() {}

G4double ScinPhotonCreation::GetEnergy() const { return energy; }
G4double ScinPhotonCreation::GetTime() const { return time; }

void ScinPhotonCreation::Draw() {}
void ScinPhotonCreation::Print() {}
